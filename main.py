...
async def menu(interaction: discord.Interaction):
    embed = discord.Embed(
        title="👾 ・『𝐌𝐄𝐍𝐔 𝐁𝐎𝐓』",
        description="📋 **Bot war 9 app by sever Anh Em Hoang Bach**",
        color=discord.Color.purple()
    )

    # Ảnh góc phải (thumbnail)
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1324987857747836999/1484429933072748605/0141619B-503C-46F2-895D-710771DB7991.png?ex=69d34a9b&is=69d1f91b&hm=6209d99618ba167bdcae603bb6996cb2991d69874ad8ba8c56d199a2bfc3a41f&")


    # Ảnh động dưới cùng
    embed.set_image(url="https://cdn.discordapp.com/attachments/1324987857747836999/1484430148714500136/50701D4D-DB3C-4791-AE87-1E8D6B1ED45A.png?ex=69d34ace&is=69d1f94e&hm=8153e59c72870d35ad0a183ff106867823a1005f458417f1e222630958e41a5a&")

    embed.set_footer(text="👉 Chúc bạn hotwar vui vẻ 🔥.\n🛠 Bot war by Nguyen Hoang Bach")
    ...
    class MenuView(View):
        ...
        @discord.ui.button(label="💬Tin nhắn kèm", style=discord.ButtonStyle.danger)
        async def msg_btn1(self, interaction: discord.Interaction, button: Button):
            await interaction.response.send_message("📩 war con cặc gì lắm thế, mày bị nứng à dùng tao ít thôi, địt mẹ mày!")
        
        @discord.ui.button(label="🤬Chửi", style=discord.ButtonStyle.secondary)
        async def msg_btn2(self, interaction: discord.Interaction, button: Button):
            await interaction.response.send_message("# NHÌN CÁI LỒN CON ĐĨ MÁ MÀY CÁI CON SÚC VẬT MẶT CẶC BÚ LỒN CHA DƯỢNG CHÉM CHA GIẾT MÁ CHÉM CỤ GIẾT CON , MÀY NỨNG QUÁ MÀY PHẢI BƠM NƯỚC VÔ LỒN HAY GÌ MÀ NHÌN TIN NHẮN CỦA CON BOT 9APP SIÊU ĐẸP TRAI NÀY ???")
        ...
        async def help_btn(self, interaction: discord.Interaction, button: Button):
            help_embed = discord.Embed(
                title=" # Hướng dẫn sử dụng bot📖 By Nguyen Hoang Bach",
                description=(
                    " > **🌟Lệnh cơ bản**\n\n"
        ...
        async def info_btn(self, interaction: discord.Interaction, button: Button):
            info_embed = discord.Embed(
                title="🤖 Thông tin Bot",
                description=(
                    "👤 Tác giả: **Nguyen Hoang Bach**\n"
                    "⚙️ Version: 1.1.0\n"
                    "💻 Ngôn ngữ: Python + discord.py\n"
                    "📅 Ngày ra mắt: 31/8/2025\n"
                    "- cần hỗ trợ ib discord admin : `130910._`"
                ),
                color=0x32CD32
            )
